      ...
      <div style={{ minHeight: "100vh", background: "#040612", color: "#fff" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 48 }}>
            <Link href="/weekly-deals/" style={{ padding: "10px 20px", background: "rgba(255,255,255,.05)", border: "1px solid rgba(255,255,255,.1)", borderRadius: 10, color: "rgba(255,255,255,.7)", textDecoration: "none", fontSize: 13, fontWeight: 600 }}>Offres de la Semaine &#8594;</Link>
