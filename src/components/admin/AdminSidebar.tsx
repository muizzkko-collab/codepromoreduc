...
import {
  ...
  RefreshCw, PlusCircle, LogOut, Globe, ChevronRight, Users, Image as ImageIcon, FileText, BookOpen, Smartphone, ShieldCheck, Images,
} from 'lucide-react'
...
const navItems = (tr: ReturnType<typeof useLang>['tr']): { href: string; icon: typeof Store; label: string; perm?: Permission }[] => [
  ...
  { href: '/admin/logos/',                  icon: Images,           label: 'Logo Manager', perm: 'stores' },
  ...
  { href: '/admin/securite/',                icon: ShieldCheck,     label: 'Sécurité',     perm: 'users' },
